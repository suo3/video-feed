...
export default function YouTubePlayer({ youtubeUrl, onClose }: YouTubePlayerProps) {
  ...
  return (
    <div id="cinema-container" className="fixed inset-0 bg-black bg-opacity-90 flex items-center justify-center z-50">
