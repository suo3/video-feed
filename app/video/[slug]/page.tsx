...
export default async function VideoDetailPage(props:{params:{slug:string}}) {
  ...
  console.log('slug', slug)
    ...
    //const foundVideo = allVideos.find(v => v.slug === slug);
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
             ...
             <SingleVideoCard id={video.id} title={video.title} category={video.cat_slug} video_url={video.video_url} slug={video.title}  thumbnail={video.thumbnail_url} />
